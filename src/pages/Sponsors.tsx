...
import { Download, ExternalLink, Handshake } from "lucide-react";
...
export const Sponsors: React.FC = () => {
      ...
      >
        <StarBorder color="#FFCDB9" speed="4s" thickness={4}>
          <GlassCard className="overflow-visible p-6 text-center max-w-xs bg-white/10 shadow-none border border-white/10">
            ...
            <p className="text-[] text-sm mb-3">{sponsor.contribution}</p>
            <motion.a
  ...
  const sponsors: Sponsor[] = [
    ...
    },
    {
      ...
      tier: "gold",
      description:
        "Startup incubator fostering technological innovation and entrepreneurship.",
    ...
    },
    {
      ...
      tier: "silver",
      description:
        "Online coding education platform with industry-focused curriculum.",
  ...
  return (
    <div className="min-h-screen pt-16 bg-[#0f0f0f] text-white">
      {/* Hero Section */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <section className="py-20">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
              <h2 className="text-3xl md:text-4xl font-bold text-white text-center mb-16">
                Sponsorship{" "}
                <span className="bg-gradient-to-r from-[#ff6b00] to-[#00c9a7] bg-clip-text text-transparent">
                  Benefits
                </span>
              </h2>
          ...
          <section className="py-20">
            <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              <GlassCard className="p-8 text-center">
                <Handshake className="w-16 h-16 text-[#ff6b00] mx-auto mb-6" />
                ...
                <motion.a
                  ...
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="inline-flex items-center space-x-2 px-6 py-3 bg-gradient-to-r from-[#00c9a7] to-[#059669] text-white rounded-lg font-medium"
                >
