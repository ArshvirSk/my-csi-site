            ...
            <ul className="space-y-16">
              {timeline.map((item, index) => (
                ...
                >
                  ...
                  <div className="hidden md:block absolute left-1/2 transform -translate-x-1/2 w-4 h-4 bg-[#f7baa8] rounded-full border-4 border-[#0f0f0f] z-10" />
                </li>
              ))}
            </ul>
          </div>
          ...
          <GlassCard className="p-8">
            ...
            <div className="flex flex-col gap-4 items-center">
              <div className="flex flex-col gap-4">
                ...
                <div className="flex items-center space-x-3">
                  <Calendar className="w-8 h-8 text-[#00c9a7] flex-shrink-0" />
                  <span className="text-neutral-400 text-sm sm:text-base">
